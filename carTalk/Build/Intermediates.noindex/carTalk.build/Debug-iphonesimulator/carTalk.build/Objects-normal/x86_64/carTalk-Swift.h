...
#ifndef CARTALK_SWIFT_H
#define CARTALK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="carTalk",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7carTalk11AppDelegate")
...
SWIFT_CLASS("_TtC7carTalk9BrandCell")
@interface BrandCell : UICollectionViewCell
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified brandImage;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified brandLabel;
...
SWIFT_CLASS("_TtC7carTalk19BrandViewController")
...
SWIFT_CLASS("_TtC7carTalk7CarCell")
@interface CarCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified name;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified era;
...
SWIFT_CLASS("_TtC7carTalk20DetailViewController")
@interface DetailViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified carImg;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified carName;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified consumption;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified power;
...
SWIFT_CLASS("_TtC7carTalk19LoginViewController")
...
SWIFT_CLASS("_TtC7carTalk18MainViewController")
...
SWIFT_CLASS("_TtC7carTalk9ModelCell")
@interface ModelCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified modelName;
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER SWIFT_AVAILABILITY(ios,introduced=3.0);
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC7carTalk20ModelsViewController")
@interface ModelsViewController : UIViewController <UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified tableView;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified topBrandLogo;
- (IBAction)back:(id _Nonnull)sender;
- (void)prepareForSegue:(UIStoryboardSegue * _Nonnull)segue sender:(id _Nullable)sender;
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC7carTalk13SceneDelegate")
